            ...
            <form method="POST" action="{{ route('conductores.store') }}" enctype="multipart/form-data" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="relative flex flex-col">
                        <label class="block font-semibold text-gray-700 dark:text-gray-300 mb-1 flex items-center">
                            Correo
                            <div class="ml-2 relative group">
                                <div class="w-5 h-5 bg-blue-500 text-white text-xs font-bold rounded-full flex items-center justify-center cursor-pointer">
                                    i
                                </div>
                                <div class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-44 bg-gray-800 dark:bg-gray-700 text-white dark:text-gray-100 text-xs rounded py-1 px-2 text-center opacity-0 group-hover:opacity-100 transition-opacity shadow-lg pointer-events-none">
                ...
                <div class="flex justify-end space-x-3 pt-4">
                    <a href="{{ route('conductores.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-md shadow-sm transition">
                        Cancelar
                    </a>
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md shadow-sm transition">
                        Guardar
                    </button>
                </div>
            </form>
