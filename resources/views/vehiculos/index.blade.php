    ...
    <div class="max-w-7xl mx-auto py-4 sm:py-8 px-4 sm:px-6">
        ...
        <div class="mb-4">
            <div class="flex space-x-2">
                <input type="text" id="search-input" placeholder="Buscar por placa, marca, modelo, tipo, propietario o conductor..." 
            ...
            searchInput.addEventListener('input', function(e) {
                ...
                searchTimeout = setTimeout(function() {
                    if (searchTerm.length >= 2 || searchTerm.length === 0) {
                        ...
                        fetch(`{{ route('vehiculos.index') }}?search=${encodeURIComponent(searchTerm)}&ajax=1`, {
                            headers: {
