...
<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-8 px-6">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold {{ $textTitle }}">PQRS</h2>
        ...
        <div class="mb-4">
            <form method="GET" action="{{ route('pqrs.index') }}" class="flex space-x-2">
                <input type="text" name="search" placeholder="Buscar por nombre, correo, tiquete, placa, tipo..." value="{{ request('search') }}"
        ...
        <div class="{{ $bgCard }} shadow-md rounded-lg overflow-hidden">
            <table class="w-full border-collapse text-sm">
                ...
                <tbody class="text-sm">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-6 {{ $textEmpty }}">No se encontraron PQRS.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
